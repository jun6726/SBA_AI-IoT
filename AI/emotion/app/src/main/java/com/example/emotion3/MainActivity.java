...
public class MainActivity extends AppCompatActivity {
    ...
    private final String subscriptionKey = "7c635f3e4436422fb69e55e34e73b96f";
...
//                            Toast.makeText(MainActivity.this, ""+result[0], Toast.LENGTH_SHORT).show();
                            Log.e("result_12412",""+result[0].faceAttributes.age);
                            Log.e("result_12412", ""+ result[0].faceAttributes.gender);
                            Log.e("result_12412", ""+result[0].faceAttributes.emotion.anger);
                            if (result == null){
                                publishProgress(
